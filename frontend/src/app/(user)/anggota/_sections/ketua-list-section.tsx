...
export function KetuaListSection({ alumni }: { alumni: MemberType[] }) {
  if (alumni.length === 0) return null;

  return (
    <section className="bg-muted/30 relative overflow-hidden px-6 py-16 md:py-24">
      <div className="mx-auto max-w-6xl">
        <motion.div
          ...
          className="mb-12"
        >
          <p className="text-primary mb-2 text-xs font-bold tracking-[0.2em] uppercase">Legacy</p>
          <h2 className="font-heading text-3xl font-bold md:text-4xl">Ketua</h2>
                ...
                <div className="relative aspect-4/3 w-full overflow-hidden">
                  {imageUrl ? (
                    ...
                    <div className="bg-muted text-muted-foreground flex aspect-4/3 w-full flex-col items-center justify-center gap-2">
                      <Crown className="h-12 w-12 opacity-30" strokeWidth={1.25} />
